...
class FormsPage {
  ...
  constructor(page: Page) {
    ...
    this.subjectsDropdown = this.page.locator('.subjects-auto-complete__value-container');
  ...
  async fillPracticeForm({
    ...
    await this.subjectsInput.waitFor();
  ...
  async uploadPicture(fileName: string) {
    ...
    const relativeFilePath = path.join(__dirname, "../resources", fileName);
