...
import { addData, editData } from "../../resources/registrationForm.json";
import practiceFormData from "../../resources/practiceForm.json";
...
*/
test("@ui TC01 - User can enter and edit data in webtables",async ({ page }) => {
...
test("@ui TC02 - Verify broken image",async ({ page }) => {
  const elementsPage = await homePage.navigateToElements();
...
test("@ui TC03 - Verify user can submit the form",async ({ page }) => {
...
test("@ui TC04 - Verify the progress bar",async ({ page }) => {
...
test("@ui TC05 - Verify the tooltip",async ({ page }) => {
...
test("@ui TC06 - Verify user can drag and drop",async ({ page }) => {
